...
# This code was extracted at some point from 
...
class Datapusher:
    ...
    def resource_exists(self, packageid, resource_name):
        ...
        :param packageid: id of resource's parent dataset
    ...
    def create_resource(self, packageid, resource_name):
        """
        Creates new resource on CKAN instance
    ...
    def create_datastore(self, resource, fields, keys=None):
        ...
        :param resource: resource ID for which new datastore is being made
    ...
    def upsert(self, resource, data, method='insert'):
        ...
        :param resource: resource into which data will be inserted
    ...
    def update_meta_data(self, resource):
        ...
        :param resource: resource for which the metadata will be modified
        :return: request status
        """
